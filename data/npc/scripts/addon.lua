...
getPlayerItemCount(cid,5888) >= 1 and getPlayerItemCount(cid,5889) >= 1 then 
                    selfSay('Did you bring me the engraved crossbow,  100 lizard leathers, 100 red dragon leather, 5 enchanted chicken wings, royal steel, hell  steel and draconian steel?', cid) 
                    talk_state = 3 
                else 
                    selfSay('I need a engraved crossbow, 100 lizard  leathers, 100 red dragon leather, 5 enchanted chicken wings, royal steel, hell steel and  draconian steel, to give you the first hunter addon. Come back when you have them.', cid) 
                    talk_state = 0 
                end 
            else 
                selfSay(addon_need_premium, cid) 
...
getPlayerItemCount(cid,5888) >= 1 and getPlayerItemCount(cid,5889) >= 1 then 
                ...
                if addon == -1 then 
                    if doPlayerTakeItem(cid,5947,1) == true and  

doPlayerTakeItem(cid,5876,100) == true and doPlayerTakeItem(cid,5948,100) == true and  

doPlayerTakeItem(cid,5891,5) == true and doPlayerTakeItem(cid,5887,1) == true and  

doPlayerTakeItem(cid,5888,1) == true and doPlayerTakeItem(cid,5889,1) == true then 
			doSendMagicEffect(posicion,12)                        selfSay(addon_give, cid) 
        ...
        elseif msgcontains(msg, 'second hunter addon') then 
            if getPlayerPremiumDays(cid) > 0 then 
                if getPlayerItemCount(cid,5875) >= 1 then 
                    selfSay('Did you bring me the sniper gloves?', cid) 
                    talk_state = 4 
                else 
                    selfSay('I need sniper gloves, to give you the  second hunter addon. Come back when you have them.', cid) 
                    talk_state = 0 
                end 
            else 
                selfSay(addon_need_premium, cid) 
...
------------------------------------------------ confirm yes ------------------------------------------------ 
        elseif msgcontains(msg, 'yes') and talk_state == 4 then 
            ...
            if getPlayerItemCount(cid,5875) >= 1 then 
                ...
                if addon == -1 then 
                    if doPlayerTakeItem(cid,5875,1) == true then 
			doSendMagicEffect(posicion,12)                        selfSay(addon_give, cid) 
...
getPlayerItemCount(cid,5880) >= 100 then 
                    selfSay('Did you bring me the chunk of crude iron  and 100 iron ores?', cid) 
                    talk_state = 5 
                else 
                    selfSay('I need a chunk of crude iron and 100  iron ores, to give you the first knight addon. Come back when you have them.', cid) 
                    talk_state = 0 
                end 
            else 
                selfSay(addon_need_premium, cid) 
...
getPlayerItemCount(cid,5880) >= 100 then 
                ...
                if addon == -1 then 
                    if doPlayerTakeItem(cid,5892,1) == true and  
...
getPlayerItemCount(cid,5887) >= 1 then 
                    selfSay('Did you bring me 100 behemoth fangs, the  damaged steel helmet, warrior\'s sweat, and royal steel?', cid) 
                    talk_state = 6 
                else 
                    selfSay('I need 100 behemoth fangs, a damaged  steel helmet, warrior\'s sweat and royal steel, to give you the second knight addon. Come  back when you have them.', cid) 
                    talk_state = 0 
                end 
            else 
                selfSay(addon_need_premium, cid) 
...
getPlayerItemCount(cid,5887) >= 1 then 
                ...
                if addon == -1 then 
                    if doPlayerTakeItem(cid,5893,100) == true and  

doPlayerTakeItem(cid,5924,1) == true and doPlayerTakeItem(cid,5885,1) == true and  

doPlayerTakeItem(cid,5887,1) == true then 
			doSendMagicEffect(posicion,12)                        selfSay(addon_give, cid) 
