                   ...
                   getPlayerLevel(player3.uid) >= required_level and getPlayerLevel(player4.uid) >= required_level then
                    ...
                    if allow_reentry or 
                       ...
                       getPlayerStorageValue(player3.uid,quest_id) <= 0 and getPlayerStorageValue(player4.uid,quest_id) <= 0 then
                        ...
                        doSummonCreature("Ungreez", demon1_position)
                        doSummonCreature("Ungreez", demon2_position)
                        doSummonCreature("Ungreez", demon3_position)
                        doSummonCreature("Ungreez", demon4_position)
                        doSummonCreature("Ungreez", demon5_position)
                        doSummonCreature("Ungreez", demon6_position)
